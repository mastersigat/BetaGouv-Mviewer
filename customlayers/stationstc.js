{
    mviewer.customLayers.stationstc = {};
    var cl = mviewer.customLayers.stationstc;
    cl.legend = { items:[] };
    var uniqueStyle = [
        new ol.style.Style({
    ...
    cl.legend.items.push({styles:uniqueStyle, label: "Stations", geometry: "Point"});
    ...
    cl.legend.items.push({styles:manyStyle(10,10,7), label: "Groupe de stations", geometry: "Point"});
    ...
    cl.layer = new ol.layer.Vector({
        source: new ol.source.Cluster({
            ...
            source: new ol.source.Vector({
                url: "../mviewer-covoiturage/data/stationstc.geojson",
    ...
    cl.handle = function(clusters, views) {
        if (clusters.length > 0 && clusters[0].properties.features) {
            ...
            var elements = [];
            var l = mviewer.getLayer("stationstc");
